...
//const uint8_t TM1637_6DIGITMAP[] = { 2, 1, 0, 5, 4, 3 };
...
void TM1637Display::display() {
  ...
  if (this->length_ == 6) {
    //this->send_byte_(TM1637_CMD_ADDR + (TM1637_6DIGITMAP[this->length_ - 1] & 0x07));
    //this->send_byte_(TM1637_CMD_ADDR + (0x3 & 0x07));
    this->send_byte_(TM1637_CMD_ADDR + (0x3 & 0x03));
  } else {
